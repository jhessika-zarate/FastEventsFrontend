<template>
  <header>
    <div class="overlay">
      ...
      <h3>Administra a todos los Asistentes</h3>
      <br />
    </div>
  </header>
  <div>
  ...
  async handleSubmit() {
    try {
      const usuarioData = {
        ...this.formData,
        rol: this.isEditing ? parseInt(this.formData.rol) : 4
      };
...
.botoncito:hover {
  ...
  header .overlay {
    ...
    background-image: linear-gradient(135deg, #ab4d00a6 10%, #251101e6 100%);
  }
